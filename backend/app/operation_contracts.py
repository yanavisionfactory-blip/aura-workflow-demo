...
KNOWN.update({
    ...
    "creator.tiktok.screen": (
        {
            "type": "object",
            "required": ["query", "candidates", "qualified_candidates", "verification_scope"],
            "properties": {
                "query": TEXT,
                "searched_profile_urls": {"type": "array", "items": TEXT},
                ...
                "qualified_candidates": {
                    ...
                    "items": {
                        ...
                        "properties": {
                            ...
                            "trimmed_mean_views": {"type": "number"},
                            "original_audio_ratio": {"type": "number"},
                            "latest_post_at": TEXT,
                            "criteria": OBJECT,
                            "evidence_complete": {"const": True},
                            "eligible_public_profile": {"const": True},
                        },
                    },
                },
